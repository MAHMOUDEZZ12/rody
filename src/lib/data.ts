...
export const professionals: Professional[] = [
  {
    ...
    image: await generateSimpleImage({prompt: 'Professional portrait of a friendly female massage therapist in a clean uniform, with a soft, out-of-focus spa background.'}),
  ...
  },
  {
    ...
    image: await generateSimpleImage({prompt: 'Professional portrait of a friendly female esthetician in a clean uniform, with a soft, out-of-focus beauty salon background.'}),
  ...
  },
  {
    ...
    image: await generateSimpleImage({prompt: 'Professional portrait of a friendly female skincare expert in a clean uniform, with a background of natural botanicals and soft light.'}),
  ...
  },
  {
    ...
    image: await generateSimpleImage({prompt: 'Professional portrait of a friendly female nail artist in a clean uniform, with a colorful display of nail polishes in the background.'}),
