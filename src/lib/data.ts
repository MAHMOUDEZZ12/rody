...
export const services: Service[] = [
  // Massage Services
  {
    ...
    dataAiHint: 'serene massage professional therapist',
    categories: ['Massage'],
  ...
  },
   {
    ...
    duration: 60,
    image: 'https://placehold.co/600x400.png',
    dataAiHint: 'couple massage branded towels',
    categories: ['Massage'],
  ...
  },
  {
    ...
    duration: 60,
    image: 'https://placehold.co/600x400.png',
    dataAiHint: 'deep tissue massage therapist uniform',
  ...
  },
  {
    ...
    duration: 60,
    image: 'https://placehold.co/600x400.png',
    dataAiHint: 'aromatherapy massage professional therapist',
    categories: ['Massage'],
    professionals: ['prof1', 'prof4'],
    addons: [...generalAddons],
  },
  {
    ...
    duration: 60,
    image: 'https://placehold.co/600x400.png',
    dataAiHint: 'sports massage therapist at work',
    categories: ['Massage', 'Treatment'],
    professionals: ['prof1'],
    addons: [...generalAddons],
  },
  {
    ...
    duration: 60,
    image: 'https://placehold.co/600x400.png',
    dataAiHint: 'maderotherapy session branded uniform',
    categories: ['Massage', 'Treatment'],
  ...
  },
  {
    ...
    duration: 75,
    image: 'https://placehold.co/600x400.png',
    dataAiHint: 'hot stone massage client relaxing',
    categories: ['Massage'],
    professionals: ['prof1', 'prof4'],
    addons: [],
  },
  {
    ...
    duration: 60,
    image: 'https://placehold.co/600x400.png',
    dataAiHint: 'lymphatic drainage treatment branded towel',
    categories: ['Massage', 'Treatment'],
    professionals: ['prof1', 'prof4'],
    addons: [],
  },
  {
    ...
    duration: 60,
    image: 'https://placehold.co/600x400.png',
    dataAiHint: 'prenatal massage therapist uniform',
    categories: ['Massage', 'Treatment'],
    professionals: ['prof1'],
    addons: [],
  },
  {
    ...
    duration: 75,
    image: 'https://placehold.co/600x400.png',
    dataAiHint: 'thai massage branded uniform',
    categories: ['Massage'],
    professionals: ['prof1', 'prof4'],
    addons: [],
  },
  ...
  // Body Treatments
  {
    ...
    duration: 45,
    image: 'https://placehold.co/600x400.png',
    dataAiHint: 'body scrub treatment professional',
  ...
  },
  {
    ...
    duration: 45,
    image: 'https://placehold.co/600x400.png',
    dataAiHint: 'gold scrub application therapist',
    categories: ['Body Treatments'],
  ...
  },
  {
    ...
    duration: 45,
    image: 'https://placehold.co/600x400.png',
    dataAiHint: 'salt scrub treatment branded towel',
    categories: ['Body Treatments'],
    professionals: ['prof4'],
    addons: [],
  },
  ...
  // Facial Services
  {
    ...
    duration: 60,
    image: 'https://placehold.co/600x400.png',
    dataAiHint: 'hydrating facial therapist uniform',
  ...
  },
  {
    ...
    duration: 75,
    image: 'https://placehold.co/600x400.png',
    dataAiHint: 'anti aging facial professional',
    categories: ['Facials', 'Treatment'],
    professionals: ['prof2', 'prof4'],
  ...
  },
  {
    ...
    duration: 75,
    image: 'https://placehold.co/600x400.png',
    dataAiHint: 'glow facial therapist uniform',
    categories: ['Facials'],
    professionals: ['prof2', 'prof4'],
    addons: [...facialAddons],
  },
  {
    ...
    duration: 60,
    image: 'https://placehold.co/600x400.png',
    dataAiHint: 'acne facial professional esthetician',
    categories: ['Facials', 'Treatment'],
    professionals: ['prof2', 'prof4'],
    addons: [...facialAddons, ...generalAddons],
  },
  {
    ...
    duration: 20,
    image: 'https://placehold.co/600x400.png',
    dataAiHint: 'high frequency treatment therapist',
    categories: ['Facials', 'Treatment'],
    professionals: ['prof2', 'prof4'],
    addons: [],
  },
  ...
  // Nail Services
  {
    ...
    duration: 45,
    image: 'https://placehold.co/600x400.png',
    dataAiHint: 'classic manicure professional therapist',
    categories: ['Nails'],
  ...
  },
  {
    ...
    duration: 50,
    image: 'https://placehold.co/600x400.png',
    dataAiHint: 'classic pedicure branded towel',
    categories: ['Nails'],
    professionals: ['prof2', 'prof5'],
    addons: [],
  },
  {
    ...
    duration: 95,
    image: 'https://placehold.co/600x400.png',
    dataAiHint: 'manicure pedicure therapist uniform',
    categories: ['Nails'],
    professionals: ['prof2', 'prof5'],
    addons: [],
  },
  {
    ...
    duration: 75,
    image: 'https://placehold.co/600x400.png',
    dataAiHint: 'gel manicure therapist uniform',
    categories: ['Nails'],
    professionals: ['prof2', 'prof5'],
    addons: [],
  },
  {
    ...
    duration: 120,
    image: 'https://placehold.co/600x400.png',
    dataAiHint: 'polygel extensions nail technician',
    categories: ['Nails'],
    professionals: ['prof5'],
    addons: [],
  },
  {
    ...
    duration: 120,
    image: 'https://placehold.co/600x400.png',
    dataAiHint: 'acrylic nails application professional',
    categories: ['Nails'],
    professionals: ['prof5'],
    addons: [],
  },
  {
    ...
    duration: 135,
    image: 'https://placehold.co/600x400.png',
    dataAiHint: 'french manicure nail technician',
    categories: ['Nails'],
    professionals: ['prof5'],
    addons: [],
  },
  ...
  // Eyelash Services
  {
    ...
    duration: 90,
    image: 'https://placehold.co/600x400.png',
    dataAiHint: 'classic eyelash extensions therapist',
  ...
  },
  {
    ...
    duration: 60,
    image: 'https://placehold.co/600x400.png',
    dataAiHint: 'eyelash refill professional esthetician',
    categories: ['Eyelashes'],
    professionals: ['prof2'],
    addons: [],
  },
  {
    ...
    duration: 120,
    image: 'https://placehold.co/600x400.png',
    dataAiHint: 'russian volume lashes professional',
    categories: ['Eyelashes'],
    professionals: ['prof2'],
    addons: [],
  },
  {
    ...
    duration: 75,
    image: 'https://placehold.co/600x400.png',
    dataAiHint: 'volume lash refill therapist',
    categories: ['Eyelashes'],
    professionals: ['prof2'],
    addons: [],
  },
  {
    ...
    duration: 60,
    image: 'https://placehold.co/600x400.png',
    dataAiHint: 'lash lift treatment professional',
...
export const professionals: Professional[] = [
  {
    ...
    dataAiHint: 'warm professional headshot therapist',
    experience: 12,
  ...
  },
  {
    ...
    image: 'https://placehold.co/400x400.png',
    dataAiHint: 'friendly professional esthetician portrait',
    experience: 8,
  ...
  },
  {
    ...
    image: 'https://placehold.co/400x400.png',
    dataAiHint: 'professional skincare expert headshot',
    experience: 7,
  ...
  },
  {
    ...
    image: 'https://placehold.co/400x400.png',
    dataAiHint: 'professional nail artist headshot',
    experience: 10,
...
export const packages: Package[] = [
    {
        ...
        originalPrice: 1350,
        image: 'https://placehold.co/600x400.png',
        dataAiHint: 'luxurious spa package branded robe',
        services: [
      ...
      },
      {
        ...
        originalPrice: 1700,
        image: 'https://placehold.co/600x400.png',
        dataAiHint: 'premium spa package woman relaxing',
        services: [
      ...
      },
      {
        ...
        originalPrice: 2100,
        image: 'https://placehold.co/600x400.png',
        dataAiHint: 'ultimate spa experience branded towels',
        services: [
