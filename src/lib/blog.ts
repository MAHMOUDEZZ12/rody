...
export const blogPosts: BlogPost[] = [
  {
    ...
    category: 'Massage',
    image: await generateImageWithFallback("A variety of massage oils in elegant bottles, with different botanicals like lavender and eucalyptus, on a clean, bright background."),
  ...
  },
  {
    ...
    category: 'Skincare',
    image: await generateImageWithFallback("A luxurious, shimmering gold face mask being applied to a woman's skin, with a rich, opulent background."),
  ...
  },
  {
    ...
    image: await generateImageWithFallback("A rich, textured coffee scrub in a beautiful bowl, surrounded by coffee beans and a hint of steam."),
  ...
  },
  {
    ...
    category: 'Massage',
    image: await generateImageWithFallback("An artistic arrangement of various wooden massage tools for Maderotherapy on a clean, neutral background."),
  ...
  },
  {
    ...
    category: 'Skincare',
    image: await generateImageWithFallback("An elegant skincare product bottle, perhaps with a dropper, with a background that suggests moisture and hydration."),
  ...
  },
  {
    ...
    category: 'Eyelashes',
    image: await generateImageWithFallback("A close-up of a beautiful eye with flawless eyelash extensions, perhaps with a tool like tweezers nearby to suggest the application process."),
  ...
  },
  {
    ...
    category: 'Nails',
    image: await generateImageWithFallback("A luxurious scene of a manicure and pedicure in progress, with bowls of water, flower petals, and clean towels."),
  ...
  },
  {
    ...
    category: 'Skincare',
    image: await generateImageWithFallback("A client receiving a high-frequency facial treatment, with the soft glow of the electrode visible on their skin."),
  ...
  },
  {
    ...
    category: 'Massage',
    image: await generateImageWithFallback("A beautiful, serene spa room set up for a couple's massage, with two tables side-by-side."),
  ...
  },
  {
    ...
    date: 'October 8, 2023',
    category: 'Nails',
    image: await generateImageWithFallback("An array of colorful nail polish bottles, artistically arranged."),
