...
export const blogPosts: BlogPost[] = [
  {
    ...
    category: 'Massage',
    image: await generateSimpleImage({prompt: "A variety of massage oils in elegant bottles, with different botanicals like lavender and eucalyptus, on a clean, bright background."}),
  ...
  },
  {
    ...
    category: 'Skincare',
    image: await generateSimpleImage({prompt: "A luxurious, shimmering gold face mask being applied to a woman's skin, with a rich, opulent background."}),
  ...
  },
  {
    ...
    image: await generateSimpleImage({prompt: "A rich, textured coffee scrub in a beautiful bowl, surrounded by coffee beans and a hint of steam."}),
  ...
  },
  {
    ...
    category: 'Massage',
    image: await generateSimpleImage({prompt: "An artistic arrangement of various wooden massage tools for Maderotherapy on a clean, neutral background."}),
  ...
  },
  {
    ...
    category: 'Skincare',
    image: await generateSimpleImage({prompt: "An elegant skincare product bottle, perhaps with a dropper, with a background that suggests moisture and hydration."}),
  ...
  },
  {
    ...
    category: 'Eyelashes',
    image: await generateSimpleImage({prompt: "A close-up of a beautiful eye with flawless eyelash extensions, perhaps with a tool like tweezers nearby to suggest the application process."}),
  ...
  },
  {
    ...
    category: 'Nails',
    image: await generateSimpleImage({prompt: "A luxurious scene of a manicure and pedicure in progress, with bowls of water, flower petals, and clean towels."}),
  ...
  },
  {
    ...
    category: 'Skincare',
    image: await generateSimpleImage({prompt: "A client receiving a high-frequency facial treatment, with the soft glow of the electrode visible on their skin."}),
  ...
  },
  {
    ...
    category: 'Massage',
    image: await generateSimpleImage({prompt: "A beautiful, serene spa room set up for a couple's massage, with two tables side-by-side."}),
