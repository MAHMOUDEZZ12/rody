        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="flex flex-col items-center md:items-start">
             <Link href="/" className="flex items-center gap-2 mb-4">
                 <Image src="https://firebasestorage.googleapis.com/v0/b/reodywellness.firebasestorage.app/o/Untitled-9%20(3).png?alt=media&token=d43f4c5b-4f6e-4cef-92d9-adf50bc8bda9" alt="Rody Wellness Logo" width={140} height={50} style={{ filter: 'brightness(0) invert(1)' }} />
            </Link>
