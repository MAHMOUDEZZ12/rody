...
export function ServiceCard({ service, imageUrl, highlight = false, theme = 'spa' }: ServiceCardProps) {
  ...
  return (
    <Card className={cn(
        "flex flex-col overflow-hidden h-full transition-all duration-300 hover:shadow-lg",
        ringColorClass,
