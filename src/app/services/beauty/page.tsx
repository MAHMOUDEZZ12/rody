...
async function BeautyPageData() {
  const heroImageUrl = await generateSimpleImage({
    prompt:
      'Artistry in Beauty: An elegant lifestyle photograph showing a woman admiring her flawless manicure in a luxurious home setting in Dubai. The scene is bright, modern, and clean. A professional female therapist in a branded uniform with a subtle emblem is visible in the soft-focus background, conveying luxury, creativity, and professionalism. High resolution, photorealistic.',
  });
