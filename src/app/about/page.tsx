...
export default function AboutUsPage() {
  return (
    <div className="container max-w-4xl px-4 py-12">
      ...
      <main className="text-lg leading-relaxed space-y-8 text-muted-foreground">
        <p>
        ...
        <section className="py-8">
          <h2 className="font-headline text-3xl text-primary mb-6">Our Philosophy: The Pillars of Rody Wellness</h2>
        ...
        <section className="py-8">
          <h2 className="font-headline text-3xl text-primary mb-6">The Heart of Rody: Our Professional Team</h2>
          <p>
        ...
        <section className="py-8 text-center bg-card rounded-lg p-8">
